		...
		for(int t = 1; t < 3; ++t)
		{
			...
			try (BufferedReader reader = new BufferedReader(new FileReader(dataFilePath))) {
	            ...
	            while ((line = reader.readLine()) != null) {
	            	...
	            	int j = i;
	            	String line1 = line;
	            	EdgeDriver driver1 = driver;
	            	fluentWait.until((EdgeDriver edgeDriver) -> {
	            		driver1.findElement(By.xpath("//a[text()='"+ line1 +"']/../..//input[@value='Add to cart']")).click();
	            		try {
							Thread.sleep(1000);
	            		...
	            		if(driver1.findElement(By.xpath("//a[@class='ico-cart']/span[@class='cart-qty']")).getText().equals(expectedQty))
	            		{
	            			return true;
	            		}
	            		else
